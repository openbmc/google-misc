...
const constexpr char* BareMetalActiveTargetTemplte = "gbmc-bare-metal-active@";
                   ...
                   const std::string& host_instance)
{
    ...
    method.append(BareMetalActiveTargetTemplate + host_instance + ".target",
                  "replace");
                       ...
                       const std::string& host_instance)
{
    sdbusplus::asio::getProperty<std::string>(
        bus, OperatingSystemService + host_instance, OperatingSystemPath,
...
int main(int argc, char** argv)
{
    ...
    std::string host_num = absl::GetFlag(FLAGS_host_number);
    ...
    try
    {
        ...
        checkPostCompleteStartup(conn, host_num);
        /*
            ...
            [&](sdbusplus::message_t& message) {
                ...
                filterTimer.async_wait(
                    [&](const boost::system::error_code& ec) {
                         ...
                         */
                        checkPostCompleteEvent(conn, host_num);
                    });
            });
