...
int SockIO::bind_to_iface(const net::IFaceBase& iface)
{
    ...
    RETURN_IF_ERROR(mreq.mr_ifindex = iface.get_index(), "ncsi::SockIO::bind_to_iface get_index");
    mreq.mr_type = PACKET_MR_PROMISC;
    RETURN_IF_ERROR(setsockopt(sockfd_, SOL_PACKET, PACKET_ADD_MEMBERSHIP, &mreq, sizeof(mreq)),
